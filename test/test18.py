...
text_size_button = tk.Button(name_frame, text="Text Size", command=change_text_size, font=("Arial", text_size, "underline"), fg=text_color, bg=bg_color)
text_size_button.pack(side="left")

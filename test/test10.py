...
# Define colors
title_color = "#000000"  # Change to black for the underlined text
text_color = "#D12727"
...
name_label = tk.Label(name_frame, text="Enter your government name:", font=("Arial", 16, "underline"), fg=text_color, bg=bg_color)

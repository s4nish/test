...
def change_text_size():
    global text_size
    new_text_size = simpledialog.askinteger("Text Size", f"Enter the new text size (Minimum: {min_text_size}, Maximum: {max_text_size}):")
    if new_text_size:
        if min_text_size <= new_text_size <= max_text_size:
            text_size = new_text_size
            set_text_sizes()
        else:
            messagebox.showerror("Text Size Error", f"Text size must be between {min_text_size} and {max_text_size}.")
